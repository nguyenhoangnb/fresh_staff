...
class App1(QtWidgets.QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        self.pub = rospy.Publisher('dataapp1', String, queue_size=10)
        self.sub = rospy.Subscriber('dataapp2', String, self.callback)
    ...
    def callback(self, msg):
        data = msg.data
        self.data_from_app.setText(f"Data from app2: {data}")
    ...
    def update_datetime(self):
        ...
        self.data_to_app.setText(f"Data to app2: Hello from app1")
        self.pub.publish(String(data="Hello from app1"))
    def close(self):
        return super().close()
