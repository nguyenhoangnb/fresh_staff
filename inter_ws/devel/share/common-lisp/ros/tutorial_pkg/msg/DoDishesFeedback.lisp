...
(cl:defmethod cl:initialize-instance :after ((m <DoDishesFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DoDishesFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tutorial_pkg-msg:<DoDishesFeedback> is deprecated: use tutorial_pkg-msg:DoDishesFeedback instead.")))

(cl:ensure-generic-function 'percent_complete-val :lambda-list '(m))
(cl:defmethod percent_complete-val ((m <DoDishesFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tutorial_pkg-msg:percent_complete-val is deprecated.  Use tutorial_pkg-msg:percent_complete instead.")
  (percent_complete m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<DoDishesFeedback>)))
  ...
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%# Feedback (trạng thái trong quá trình chạy)~%float32 percent_complete~%~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'DoDishesFeedback)))
  "Returns full string definition for message of type 'DoDishesFeedback"
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%# Feedback (trạng thái trong quá trình chạy)~%float32 percent_complete~%~%~%~%~%"))
